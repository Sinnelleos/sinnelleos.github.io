...
related_posts: true
thumbnail: assets/img/existentialist-cafe-sartre-camus-beauvoir.jpeg
---

[Book in question](https://sinne.link/books/existentialist-cafe).

<div class="row mt-3">
    <div class="col-md-6 offset-md-3 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/existentialist-cafe-sartre-camus-beauvoir.jpeg" class="img-fluid rounded z-depth-1" %}
    </div>    
</div>
<div class="caption">
